...
# this method will get the access token: http://127.0.0.1:4995/auth/twitter?oauth_verifier=1234567
def twitter_auth():
...
app.run(port=4995, debug=True)  # GET HTTP/2 www.api.example.com/users
